...
// Authentifie les appels inter-services autorises a creer des notifications systeme.
@Component
      ...
      UsernamePasswordAuthenticationToken authentication =
        new UsernamePasswordAuthenticationToken(
          ...
          List.of(
            ...
            new SimpleGrantedAuthority("NOTIFICATION_INTERNAL"),
            new SimpleGrantedAuthority("NOTIFICATION_VIEW_ALL"),
            new SimpleGrantedAuthority("NOTIFICATION_MANAGE")
          )
        );
