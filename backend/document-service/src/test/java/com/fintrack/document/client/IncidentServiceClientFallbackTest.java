package com.fintrack.document.client;
...
class IncidentServiceClientFallbackTest {
  @Test
  void authorizationFallbackNeverAllowsAnUpload() {
    assertThat(fallback.authorizeAttachment(UUID.randomUUID(), "COMMENT", UUID.randomUUID())).isFalse();
  }
