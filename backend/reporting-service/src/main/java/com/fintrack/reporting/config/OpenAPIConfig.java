...
public class OpenAPIConfig {
  ...
  // Definit le schema de securite Bearer JWT et les metadonnees de l'API
  @Bean
  public OpenAPI openAPI() {
    return new OpenAPI()
      ...
      .info(
        new Info()
          .title("FinTrack Reporting Service API")
          .description(
            "API documentation for the Reporting & Dashboard microservice"
          )
          .version("v1.0")
      );
  }
